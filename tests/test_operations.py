...
class TestModulus(BaseOperationTest):
    ...
    valid_test_cases = {
        ...
        "decimal_values": {"a": "10.5", "b": "2", "expected": "0.5"},
...
class TestPercentage(BaseOperationTest):
    ...
    valid_test_cases = {
        "half_percent": {"a": "50", "b": "200", "expected": "25"},
        "full_percent": {"a": "5", "b": "5", "expected": "100"},
        "decimal_inputs": {"a": "2.5", "b": "10", "expected": "25"},
        "negative_numerator": {"a": "-5", "b": "20", "expected": "-25"},
        "zero_numerator": {"a": "0", "b": "9", "expected": "0"},
    }
    invalid_test_cases = {
        "divide_by_zero": {
            "a": "5",
...
class TestAbsoluteDifference(BaseOperationTest):
    ...
    valid_test_cases = {
        "a_greater_than_b": {"a": "10", "b": "3", "expected": "7"},
        "b_greater_than_a": {"a": "3", "b": "10", "expected": "7"},
        "equal_values": {"a": "5", "b": "5", "expected": "0"},
        "negative_and_positive": {"a": "-2", "b": "3", "expected": "5"},
        "decimals": {"a": "3.75", "b": "1.25", "expected": "2.5"},
    }
    invalid_test_cases = {}
